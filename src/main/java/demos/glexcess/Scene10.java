...
final class Scene10 implements Scene {
    ...
    private void init(GLDrawable g) {
        ...
        gl.glLoadIdentity();
        glu.gluPerspective(45.0f, (float) g.getSize().width / (float) g.getSize().height, 0.1f, 4.6f);
    ...
    private static void i_drawquad(GL gl, float size) {
    ...
    private static void i_drawtqd(GL gl, float size, float off, int a, int r, int g, int b) {
        gl.glBegin(GL.GL_QUADS);
    ...
    private static void i_drawtqd1(GL gl, float size, float off, int a, int r, int g, int b) {
        gl.glBegin(GL.GL_QUADS);
        gl.glColor4i(0, 0, 0, 0);
        gl.glTexCoord2f(0.0f + off, 0.0f);
        gl.glVertex3f(-0.5f * size, -0.5f * size, 0.0f);
    ...
    private static void i_drawtri(GL gl, float r, float g, float b, float a, float size) {
    ...
    public final boolean drawScene(GLDrawable g, float globtime) {
        ...
        gl.glEnable(GL.GL_TEXTURE_GEN_S);						///////////////////// STROBE
        gl.glEnable(GL.GL_TEXTURE_GEN_T);
        gl.glTexGeni(GL.GL_S, GL.GL_TEXTURE_GEN_MODE, GL.GL_SPHERE_MAP);
        gl.glTexGeni(GL.GL_T, GL.GL_TEXTURE_GEN_MODE, GL.GL_SPHERE_MAP);
        //glBindTexture(GL.GL_TEXTURE_2D, texture[9]);
        i_Text[10].use(gl);
        gl.glPushMatrix();
        ...
        //glBindTexture(GL.GL_TEXTURE_2D, texture[10]);
        i_Text[11].use(gl);
        gl.glColor4f((float)Math.cos(i_radius[0]) * (float)Math.cos(i_radius[0]) + (float)Math.cos(i_radius[3]) * (float)Math.cos(i_radius[3]) + (float)Math.cos(i_radius[4]) * (float)Math.cos(i_radius[4]) + (float)Math.cos(i_radius[5]) * (float)Math.cos(i_radius[5]),
                ...
                .75f);
        gl.glPushMatrix();
        //glBindTexture(GL.GL_TEXTURE_2D, texture[11]);
        i_Text[12].use(gl);
        ...
        if ((i_radius[0] > -1.495) && (i_radius[0] < 1.495)) {
            ...
            gl.glTexGeni(GL.GL_S, GL.GL_TEXTURE_GEN_MODE, GL.GL_EYE_LINEAR);
            gl.glTexGeni(GL.GL_T, GL.GL_TEXTURE_GEN_MODE, GL.GL_EYE_LINEAR);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[8]);
            i_Text[9].use(gl);
            gl.glBegin(GL.GL_TRIANGLE_FAN);
        ...
        if ((i_radius[0] > -1.495) && (i_radius[0] < 1.495)) {
            ...
            gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[1]);
            i_Text[2].use(gl);
        ...
        if ((i_radius[1] > -1.495) && (i_radius[1] < 1.495)) {
            ...
            gl.glScalef(4, 1, 1);
            gl.glColor4ub((byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte)255);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[2]);
            i_Text[3].use(gl);
            i_drawquad(gl, 1);
            gl.glPopMatrix();

            gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[3]);
            i_Text[4].use(gl);
            for (i_x = 0; i_x < i_num; i_x++) {
        ...
        if ((i_radius[3] > -1.495) && (i_radius[3] < 1.495)) {
            ...
            gl.glScalef(4, 1, 1);
            gl.glColor4ub((byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte)255);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[6]);
            i_Text[7].use(gl);
            i_drawquad(gl, 1);
            gl.glPopMatrix();

            gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[7]);
            i_Text[8].use(gl);
            for (i_x = 0; i_x < i_num; i_x++) {
        ...
        if ((i_radius[2] > -1.495) && (i_radius[2] < 1.495)) {
            ...
            gl.glScalef(4, 1, 1);
            gl.glColor4ub((byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte)255);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[4]);
            i_Text[5].use(gl);
            i_drawquad(gl, 1);
            gl.glPopMatrix();

            gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[5]);
            i_Text[6].use(gl);
            for (i_x = 0; i_x < i_num; i_x++) {
        ...
        if ((i_radius[4] > -1.495) && (i_radius[4] < 1.495)) {
            ...
            gl.glScalef(4, 1.5f, 1);
            gl.glColor4ub((byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte)255);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[17]);
            i_Text[18].use(gl);
            i_drawquad(gl, 1);
            gl.glPopMatrix();

            gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[18]);
            i_Text[19].use(gl);
            for (i_x = 0; i_x < i_num; i_x++) {
        ...
        if ((i_radius[5] > -1.495) && (i_radius[5] < 1.495)) {
            ...
            gl.glScalef(4, .5f, 1);
            gl.glColor4ub((byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte)255);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[15]);
            i_Text[16].use(gl);
            i_drawquad(gl, 1);
            gl.glPopMatrix();

            gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[16]);
            i_Text[17].use(gl);
            for (i_x = 0; i_x < i_num; i_x++) {
        ...
        if ((i_radius[6] > -1.495) && (i_radius[6] < 1.495)) {
            ...
            gl.glScalef(8, 2, 1);
            gl.glColor4ub((byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte) ((float) 255 * i_shade), (byte)255);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[13]);
            i_Text[14].use(gl);
            ...
            gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE);
            //glBindTexture(GL.GL_TEXTURE_2D, texture[14]);
            i_Text[15].use(gl);
            gl.glTexParameterf(GL.GL_TEXTURE_2D, GL.GL_TEXTURE_WRAP_S, GL.GL_CLAMP);
            gl.glTexParameterf(GL.GL_TEXTURE_2D, GL.GL_TEXTURE_WRAP_T, GL.GL_CLAMP);
            for (i_x = 0; i_x < i_num; i_x++) {
        ...
        gl.glPushMatrix();
        //glBindTexture(GL.GL_TEXTURE_2D, texture[12]);
        i_Text[13].use(gl);
